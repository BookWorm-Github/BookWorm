						...
						<MDBContainer>
							...
							<MDBCollapse isOpen={this.state.collapse1} navbar>
								<MDBNavbarNav left>
									<MDBNavItem active>
										<MDBNavLink to="#!"
										            onClick={() => this.props.deleteBook(this.props.book)}>Delete</MDBNavLink>
									</MDBNavItem>
									<MDBNavLink to="#!"
									            onClick={() => chrome.runtime.sendMessage({rq: "getCurrWindowId"}, this._cbWindowIdResponse.bind(this))}>Link
										to book</MDBNavLink>
									<MDBNavItem>
							...
							<button className='nav-bar' id={this.props.book.key.toString()}
							        onClick={() => this.toggleSingleCollapse('collapse1')}><i
