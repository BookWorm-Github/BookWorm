    ...
    return function(t) {
        ...
        t.exports = function(t, n) {
            ...
            return function(n, a, v) {
                for (var d, y, g = i(n), m = o(g), b = e(a, v, 3), w = u(m.length), x = 0, S = r ? p(n, w) : c ? p(n, 0) : void 0; w > x; x++)
        ...
        if (r(8)) {
            ...
            p(Yt, Ct), h(Yt, vt, Ct.values), p(Yt, {
                ...
                h(v, yt, !0), h(_, bt, f), h(_, wt, !0), h(_, gt, v), (c ? new v(1)[dt] == f : dt in _) || Y(_, dt, {
                    ...
                    from: jt,
                    of: Mt
                }), "BYTES_PER_ELEMENT" in _ || h(_, "BYTES_PER_ELEMENT", n), u(u.P, f, Nt), L(f), u(u.P + u.F * _t, f, {
                    set: Lt
                }), u(u.P + u.F * !T, f, Ct), e || _.toString == ht || (_.toString = ht), u(u.P + u.F * i((function() {
                    new v(1).slice()
                })), f, {
                    slice: kt
        ...
        t.exports = function(t, n, r, v, d, y, g) {
            ...
            var m, b, w, x = function(t) {
                ...
                E = !1,
                A = t.prototype,
                P = A[l] || A["@@iterator"] || d && A[d],
                O = P || x(d),
                R = d ? _ ? x("entries") : O : void 0,
            ...
            if (T && (w = s(T.call(new t))) !== Object.prototype && w.next && (f(w, S, !0), e || "function" == typeof w[l] || u(w, l, p)), _ && P && "values" !== P.name && (E = !0, O = function() {
                    return P.call(this)
                }), e && !g || !h && !E && A[l] || u(A, l, O), a[n] = O, a[S] = p, d)
                if (m = {
                        values: _ ? O : x("values"),
                        keys: y ? O : x("keys"),
                        entries: R
        ...
        t.exports = !f || r(2)((function() {
            ...
            for (var r = a(t), f = arguments.length, s = 1, l = i.f, h = u.f; f > s;)
                for (var p, v = c(arguments[s++]), d = l ? o(v).concat(l(v)) : o(v), y = d.length, g = 0; y > g;) p = d[g++], e && !h.call(v, p) || (r[p] = v[p]);
            return r
        } : f
    }, function(t, n) {
        ...
        var e, o, i, u, a = r(31),
            ...
            L = function(t) {
                g.call(c, (function() {
                    var n;
                    R ? E.emit("rejectionHandled", t) : (n = c.onrejectionhandled) && n({
                        promise: t,
                        reason: t._v
                    })
                }))
        ...
        M || (O = function(t) {
            ...
            Promise: O
        }), r(39)(O, "Promise"), r(42)("Promise"), u = r(7).Promise, l(l.S + l.F * !M, "Promise", {
            reject: function(t) {
                var n = j(this);
        ...
        "use strict";
        r(135);
        var e, o = (e = r(307)) && e.__esModule ? e : {
            default: e
        };
        ...
        var e = r(1),
            ...
            X = function(t, n, r) {
                return t === W && X(Y, n, r), m(t), n = S(n, !0), m(r), o(D, n) ? (r.enumerable ? (o(t, L) && t[L][n] && (t[L][n] = !1), r = E(r, {
                    enumerable: _(0, !1)
                })) : (o(t, L) || M(t, L, _(1, {})), t[L][n] = !0), q(t, n, r)) : M(t, n, r)
            },
            $ = function(t, n) {
                m(t);
        ...
        o(o.S + o.F * !r(53)((function(t) {
            ...
            from: function(t) {
                var n, r, o, l, h = i(t),
                    ...
                    g = 0,
                    m = s(h);
                if (y && (d = e(d, v > 2 ? arguments[2] : void 0, 2)), null == m || p == Array && a(m))
        ...
        r(56)("split", 2, (function(t, n, r, s) {
            ...
            return v = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(t, n) {
                ...
                for (var i, u, a, c = [], s = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""), l = 0, p = void 0 === n ? 4294967295 : n >>> 0, v = new RegExp(t.source, s + "g");
                    (i = f.call(v, o)) && !((u = v.lastIndex) > l && (c.push(o.slice(l, i.index)), i.length > 1 && i.index < o.length && h.apply(c, i.slice(1)), a = i[0].length, l = u, c.length >= p));) v.lastIndex === i.index && v.lastIndex++;
                ...
                for (var w = 0, x = 0, S = []; x < h.length;) {
                    ...
                    if (null === E || (_ = l(a(m.lastIndex + (p ? 0 : x)), h.length)) === w) x = u(h, x, y);
                    else {
        ...
        t.exports = function t(n, r, c, f, s, l, h, p) {
            for (var v, d, y = s, g = 0, m = !!h && u(h, p, 3); g < f;) {
                if (g in c) {
                    if (v = m ? m(c[g], g, r) : c[g], d = !1, o(v) && (d = void 0 !== (d = v[a]) ? !!d : e(v)), d && l > 0) y = t(n, r, v, i(v.length), y, l - 1) - 1;
                    else {
                    ...
                    return regeneratorRuntime.wrap((function(t) {
                        for (;;) switch (t.prev = t.next) {
                            ...
                            case 43:
                                return p = {
                                    withCredentials: !0
                                }, void 0 !== u.getHeaders && (p.headers = u.getHeaders()), t.next = 47, o.post(s(r), u, p);
                            case 47:
        ...
        (function(t) {
            ...
            c.prototype.slice = function(t, n) {
                var r, e = this.length;
                if ((t = ~~t) < 0 ? (t += e) < 0 && (t = 0) : t > e && (t = e), (n = void 0 === n ? e : ~~n) < 0 ? (n += e) < 0 && (n = 0) : n > e && (n = e), n < t && (n = t), c.TYPED_ARRAY_SUPPORT)(r = this.subarray(t, n)).__proto__ = c.prototype;
                else {
                    var o = n - t;
                    r = new c(o, void 0);
                ...
                var o, i = e - r;
                if (this === t && r < n && n < e)
                    for (o = i - 1; o >= 0; --o) t[o + n] = this[o + r];
                else if (i < 1e3 || !c.TYPED_ARRAY_SUPPORT)
                    for (o = 0; o < i; ++o) t[o + n] = this[o + r];
                ...
                if (n >>>= 0, r = void 0 === r ? this.length : r >>> 0, t || (t = 0), "number" == typeof t)
                    for (i = n; i < r; ++i) this[i] = t;
                else {
                    var u = c.isBuffer(t) ? t : Y(new c(t, e).toString()),
                        a = u.length;
            ...
            return (p = i(regeneratorRuntime.mark((function t(n) {
                ...
                return regeneratorRuntime.wrap((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        ...
                        case 3:
                            return t.next = 5, fetch(u + "/get_standard_api_result_data/" + n.id, {
                                credentials: "include"
                            });
                        case 5:
                    ...
                    if (1 == t.inputs.length && t.inputs[0].is_img && t.visualizer_data) {
                        ...
                        return f.onload = function() {
                            ...
                            var o = function() {
                                ...
                                var t = f.contentDocument.body.scrollWidth,
                                    n = f.contentDocument.body.scrollHeight,
                                    o = e.offsetWidth,
                                    i = e.offsetHeight,
                                    u = f.offsetWidth,
                                    a = f.offsetHeight,
                            ...
                            var i = function(t, n, r) {
                                ...
                                for (var o = Math.min(15, e.length), i = [], u = 0; u < o; u++) {
                                    var a, c = e[u];
                                    if ("demographic" == n.label_key) a = c[n.label_key] ? c[n.label_key] : c.cultural_appearance + " " + c.gender + ", " + c.age_range[0] + "-" + c.age_range[1];
                                    else if ("people" == n.label_key) {
                                        var f = [];
                                        ...
                                        c.mask_vertices = s
                                    } else if ((a = c[n.label_key]) && a.constructor === String);
                                    else {
                                        var g = Object.keys(a);
                            ...
                            try {
                                for (var v, d = i[Symbol.iterator](); !(c = (v = d.next()).done); c = !0) {
                                    var y, g, m, b, w = v.value,
                                        x = document.createElement("boundingbox");
